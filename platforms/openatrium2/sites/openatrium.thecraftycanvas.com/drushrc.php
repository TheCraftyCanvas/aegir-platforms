...
$options['db_passwd'] = 'QmD4fQL92C';
$options['db_name'] = 'openatriumthecra';
$options['db_user'] = 'openatriumthecra';
...
@include_once('/var/aegir/platforms/openatrium2/sites/openatrium.thecraftycanvas.com/local.drushrc.php');
